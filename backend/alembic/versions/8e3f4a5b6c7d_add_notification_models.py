...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('sms_opt_in_at', postgresql.TIMESTAMPTZ(), nullable=True),
        ...
        sa.Column('last_sms_failure_at', postgresql.TIMESTAMPTZ(), nullable=True),
        sa.Column('last_email_failure_at', postgresql.TIMESTAMPTZ(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('scheduled_for', postgresql.TIMESTAMPTZ(), nullable=False),
