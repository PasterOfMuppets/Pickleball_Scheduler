...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('start_time', postgresql.TIMESTAMPTZ(), nullable=False),
        sa.Column('end_time', postgresql.TIMESTAMPTZ(), nullable=False),
        ...
        sa.Column('confirmed_at', postgresql.TIMESTAMPTZ(), nullable=True),
        sa.Column('declined_at', postgresql.TIMESTAMPTZ(), nullable=True),
        sa.Column('canceled_at', postgresql.TIMESTAMPTZ(), nullable=True),
